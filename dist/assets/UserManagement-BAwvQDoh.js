import{r as p,w as v,x as b,y as O,z as T,A as R,_,C as U,F as L,D as P,E as F,G as w,j as i,B as M,a as $,H as g,I as N,d as D}from"./index-UP4maj2k.js";const G=()=>{const[e,t]=p.useState([]),[n,r]=p.useState(!0),[s,a]=p.useState(null),c=async()=>{r(!0),a(null);try{const o=v(b,"users"),l=(await O(o)).docs.map(f=>{var E,k;const d=f.data();return{uid:f.id,email:d.email||"",role:d.role||"client",createdAt:(E=d.createdAt)==null?void 0:E.toDate(),updatedAt:(k=d.updatedAt)==null?void 0:k.toDate()}});t(l)}catch(o){console.error("Erreur lors de la récupération des utilisateurs:",o),a(o.message||"Échec de la récupération des utilisateurs")}finally{r(!1)}};return p.useEffect(()=>{c()},[]),{users:e,loading:n,error:s,refetch:c}};/**
 * @license
 ...
 */const B="type.googleapis.com/google.protobuf.Int64Value",H="type.googleapis.com/google.protobuf.UInt64Value";function j(e,t){const n={};for(const r in e)e.hasOwnProperty(r)&&(n[r]=t(e[r]));return n}function A(e){if(e==null)return null;if(e instanceof Number&&(e=e.valueOf()),typeof e=="number"&&isFinite(e)||e===!0||e===!1||Object.prototype.toString.call(e)==="[object String]")return e;if(e instanceof Date)return e.toISOString();if(Array.isArray(e))return e.map(t=>A(t));if(typeof e=="function"||typeof e=="object")return j(e,t=>A(t));throw new Error("Data cannot be encoded in JSON: "+e)}function m(e){if(e==null)return e;if(e["@type"])switch(e["@type"]){case B:case H:{const t=Number(e.value);if(isNaN(t))throw new Error("Data cannot be decoded from JSON: "+e);return t}default:throw new Error("Data cannot be decoded from JSON: "+e)}return Array.isArray(e)?e.map(t=>m(t)):typeof e=="function"||typeof e=="object"?j(e,t=>m(t)):e}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ee="auth-internal",te="app-check-internal",ne="messaging-internal";function re(e,t){const n=(r,{instanceIdentifier:s})=>{const a=r.getProvider("app").getImmediate(),c=r.getProvider(ee),o=r.getProvider(ne),u=r.getProvider(te);return new K(a,c,o,u,s,e)};P(new F(x,n,"PUBLIC").setMultipleInstances(!0)),w(C,S,t),w(C,S,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
