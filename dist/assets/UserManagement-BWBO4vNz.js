 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ee="auth-internal",te="app-check-internal",ne="messaging-internal";function re(e,t){const n=(r,{instanceIdentifier:s})=>{const a=r.getProvider("app").getImmediate(),c=r.getProvider(ee),o=r.getProvider(ne),u=r.getProvider(te);return new K(a,c,o,u,s,e)};P(new F(x,n,"PUBLIC").setMultipleInstances(!0)),w(I,v,t),w(I,v,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
