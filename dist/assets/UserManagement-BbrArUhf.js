import{r as h,x as J,y as q,z as K,A as S,C as X,_ as Y,E as W,G as Q,H as Z,I as ee,J as I,j as i,K as N,L as T,T as te,B as ne,a as se,h as w}from"./index-CYGiFNkt.js";import{M as re}from"./Modal-BiZSLuML.js";import{T as oe}from"./Table-rhIXLlsd.js";import{d as ie,u as ae,a as le,b as ce,g as ue,c as de}from"./index-Boq9C-g5.js";import{T as he,f as U}from"./TableSearch-BOjTgjUs.js";import"./Input-BJElJ-69.js";const ge=()=>{const[e,t]=h.useState([]),[n,s]=h.useState(!0),[r,o]=h.useState(null),a=async()=>{s(!0),o(null);try{const l=J(q,"users"),d=(await K(l)).docs.map(f=>{var m,E;const c=f.data();return{uid:f.id,email:c.email||"",role:c.role||"client",createdAt:(m=c.createdAt)==null?void 0:m.toDate(),updatedAt:(E=c.updatedAt)==null?void 0:E.toDate()}});t(d)}catch(l){console.error("Error fetching users:",l),o(l.message||"Failed to fetch users")}finally{s(!1)}};return h.useEffect(()=>{a()},[]),{users:e,loading:n,error:r,refetch:a}};/**
 * @license
...
//# sourceMappingURL=UserManagement-BbrArUhf.js.map
