...
var myForm = new AgileForm(); // Fonction exécutée après le chargement de la page
...
bookmarkElement.classList.toggle("fa-regular")
  ...
  while (question = myForm.getNextQuestion()) {
    ...
    input.attr("name", "answer__" + questionId);
    input.attr("type", "radio");
    input.attr("class", "answerInput");
    input.attr("data-questionId", questionId);
    var currentInput;
    questionDisplay.attr("id", "questionDisplay__" + questionId);
    questionDisplay.addClass("questionDisplay");
  ...
  <label for="bookmark${questionId}"></label>
    ...
    if (question.getAnswerType() == "TF") {
      ...
      currentInput.attr("value", "1");
 	currentInput.attr("id", "answer__true__" + questionId);
	var answerDivTrue = jquery__WEBPACK_IMPORTED_MODULE_0___default()(
			`<div class="answerInputWrapper ${question.getAnswer() === true && "answer_00"}" data-questionId="${questionId}"></div>`
			);
	var answerDivFalse = jquery__WEBPACK_IMPORTED_MODULE_0___default()(
			`<div class="answerInputWrapper ${question.getAnswer() === false && "answer_00"}" data-questionId="${questionId}"></div>`
			);
      var labelTrue = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<label>True</label>");
	  labelTrue.attr("for", "answer__true__" + questionId)
	  labelTrue.attr("data-questionId", questionId);
      answerDivTrue.append(currentInput);
      answerDivTrue.append(labelTrue);
      questionDisplay.append(answerDivTrue);
      currentInput = input.clone();
  ...
  answerDiv.append(currentInput);
  answerDiv.append(label);
  questionDisplay.append(answerDiv);
      }
    } else {
      var answers = question.getAnswers();
      for (var i = 0; i < answers.length; i++) {
  ...
  questionDisplay.append(answerDiv);
    ...
    var feedback = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div class='questionFeedback hide-for-print'><p id=\"questionFeedback__" + questionId + "\" ><span class='bold'>Feedback : </span>" + question.getFeedback() + "</p></div>");
    questionDisplay.append(feedback);
    displayQuestions.append(questionDisplay);
  }

  myForm.setCurrentQuestion(0);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".questionsOne").hide();
  ...
  element.classList.remove("success");
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".questionNext").removeAttr("disabled");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".questionPrevious").removeAttr("disabled");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".questionLast").removeAttr("disabled");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".questionBeginning").removeAttr("disabled");

    if (newQuestion + 1 == myForm.getQuestionsCount()) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".questionNext").attr("disabled", "true");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".questionLast").attr("disabled", "true");
    }
  ...
  // ANCHOR : Show previous question
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".questionPrevious").on("click", function () {
			const elements = document.getElementsByClassName("answer_00");
			for (const element of elements) {
  element.classList.remove("success");
}
  ...
  // ANCHOR : Show next question
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".questionNext").on("click", function () {
		const elements = document.getElementsByClassName("answer_00");
			for (const element of elements) {
  element.classList.remove("success");
}
  ...
  // ANCHOR : Handle change current question input
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".currentQuestionInput").on("change", function () {
    var currentQuestion = parseInt(myForm.getCurrentQuestion());
    var newQuestion = parseInt(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val()) - 1;

    if (newQuestion >= myForm.getQuestionsCount()) {
      newQuestion = myForm.getQuestionsCount() - 1;
    }
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".currentQuestionInput").val(parseInt(myForm.getCurrentQuestion()) + 1);
	jquery__WEBPACK_IMPORTED_MODULE_0___default()(".count").val(parseInt(myForm.getQuestionsCount()));
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".answerInput").on("change", function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("type") == "checkbox" && !jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).prop("checked")) {
      myForm.removeAnswer(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("data-questionId"), jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val());
    } else {
      myForm.addAnswer(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("data-questionId"), jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val());
    }
  });
...
const playPauseButtonIcon = document.getElementById("playPauseIcon");
...
const countdown = setInterval(() => {
  ...
  timerWrapper.style.setProperty("--value", remaingMinutes);
  ...
  if (seconds === 0) {
	...
	playPauseButtonIcon.classList.remove("fa-pause", "fa-play")
  }
...
module.exports = __webpack_require__(/*! /Users/marcmarliot/Documents/public_html/revisions/src/assets/js/app.js */"./src/assets/js/app.js");
