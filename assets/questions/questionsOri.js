var questionsTitle = "Professional Scrum Master";
...
*/
	...
	{
		title: 		"Which three questions might be answred by Development Team members at the Daily Scrum ?",
		answerType: "M",
		answers: 	[
	...
	{
		title: 		"Which two of the following are true about the Scrum Master role ? (choose the best two answers)",
		answerType: "M",
		answers: 	[
	...
	{
		title: 		"The Product owner must use:",
		answerType: "M",
		answers: 	[
	...
	{
		title: 		"What are advantages of a Product Owner with a solid product vision? Choose 3 answers.",
		answerType: "M",
		answers: 	[
	...
	{
		title: 		"A Product Backlog is: Choose 3 answers.",
		answerType: "M",
		answers: 	[
	...
	{
		title: 		"A product success is measured by :  Choose three answers",
		answerType: "M",
		answers: 	[
						"The impact on customer satisfaction",	
						"The delivery of upfront defined scope compared to the upfront planned time",	
	...
	{
		title: 		"My job as a Product Owner focuses on the following: Choose two answers",
		answerType: "M",
		answers: 	[
						"Writing clear, transparent User Stories.",
						"Working with customers and stakeholders to identify the most important product requirements.",
	...
	{
		title:		"What are two ways that architecture and infrastructure are handled in Scrum ? Choose two answers",
		answerType: "M",
		answers: 	[
						"They are discussed, determined, and documented before the actual feature development Sprints",
						...
						"They are built by a separate team trhough the creation of an architectural runway",
						"They are implemented along with functional development of the product"
					],
		answer: 	[1,3],
		feedback: 	""
	...
	{
		title:		"What is typical work for a Product Owner in a Sprint ? Choose two answers",
		answerType: "M",
		answers: 	[
						"Attend every Daily Scrum to answer functional questions on the discussed Sprint Backlog items.",
						"Update the work plan for the Development Team on a daily basis",
	...
	{
		title:		"What three things might a Scrum Product Owner focus on to ensure his product delivers value ? Choose three answers",
		answerType: "M",
		answers: 	[
	...
	{
		title:		"Which of the following are true about the length of the Sprint ? Choose two answers",
		answerType: "M",
		answers: 	[
						"All Sprints must be 1 month or less",
						"It is best to have Sprints of consistent length throughout a development effort",
	...
	{
		title:		"Which of the following practices might help the Product Owner minimize waste in developing and sustaining the Product Backlog ? Choose two answers",
		answerType: "M",
		answers: 	[
						"Let others manage the Product Backlog",
						"Only fully describe Product Backlog items when it seems sure that they are likely to be implemented",
	...
	{
		title:		"You are a product manager with a proven track record in your company. Your management has asked you to take the lead in the development of a new product. Six teams new to Scrum will build this product. What would you strive for ? Choose two answers",
		answerType: "M",
		answers: 	[
						"The product has one Product Backlog",
						"There should be six Product Owners, one for each Scrum team ",
	...
	{
		title:		"How is management external to the Scrum Team involved in the Daily Scrum ?",
		answerType: "S",
		answers: 	[
						"The Scrum Master speaks on their behalf",
						"Management gives an update at the start of each Daily Scrum",
