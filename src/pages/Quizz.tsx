...
export default function Quizz() {
  ...
  const notifyTime = () => {
    // We access the current value of the ref
    const currentTimeSpent = timeSpentRef.current;
    if (currentTimeSpent <= 3) return;
    ...
    const toastOptions: any = {
      ...
      draggable: false,
      closeButton: false,
      type: toastType(currentTimeSpent),
    };

    toast(
      notificationContent(currentQuestion, formatTime(currentTimeSpent)),
      toastOptions
    );
  };
